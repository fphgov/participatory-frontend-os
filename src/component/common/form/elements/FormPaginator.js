...
export default function FormPaginator({ children, prevStep, nextStep, firstStep, nextStepInvalid = false }) {
  return (
    <div className="navigation-wrapper">
      ...
      {nextStep ? <button type="button" className="next-step" onClick={nextStep} disabled={nextStepInvalid} >Következő <FontAwesomeIcon icon={faCaretRight} /></button> : null}
