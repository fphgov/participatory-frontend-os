      ...
      <div className="container">
        <div className="row">
          <div className="col-md-12">
            ...
            <p>A lenti gombra kattintva tud jelentkezni a nyereményjátékra.<br />A jelentkezéssel elfogadja az adatkezelési tájékoztatónk 5/C pontja szerinti, a nyereményjátékhoz <a href={`${process.env.REACT_APP_SERVER_FILE}/files/adatkezelesi_tajekozato.pdf`} style={{ textDecoration: 'underline' }} rel="noopener noreferrer">kapcsolódó adatkezelést</a>.</p>
