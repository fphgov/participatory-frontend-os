...
export default class Projects extends React.Component {
  ...
  componentDidMount() {
    ...
    this.setState({
      inputSearch: search.get('query') ? search.get('query') : '',
    })
  }
  ...
  onKeyUp(e) {
    if (e.key === 'Enter') {
      ...
      search.set("query", this.state.inputSearch)
          ...
          <div className="container">
              ...
              <div className="col-md-12">
                ...
                <div className="form-group">
                  ...
                  <div className="input-group">
                    <input className="form-control" type="text" name="query" value={this.state.inputSearch} placeholder="Keresés" id="search" onKeyUp={this.onKeyUp} onChange={this.handleChange} />
            ...
            <div className="row">
              <div className="col-md-3 col-xs-12">
                <select>
                  <option value="0">Keresés helyszín alapján</option>
              ...
              <div className="col-md-3 col-xs-12">
                <select>
                  <option value="0">Keresés kategória alapján</option>
                  <option disabled="disabled">----</option>
