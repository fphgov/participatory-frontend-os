...
export default function Projects() {
  ...
  const findIdeas = (e) => {
    ...
    let link = process.env.REACT_APP_API_ADMIN_REQ_PROJECTS
  ...
  return (
    <div className="reports">
      <div className="container">
        ...
        <h2 className="mt-5">Megvalósuló ötletek</h2>
        ...
        <div className="mt-4 row">
          ...
          {Array.isArray(projects) && projects.map((project, i) => <div key={i} style={{ width: "100%" }}> <ListElement key={i} name="project" object={project} /></div>)}
        </div>
